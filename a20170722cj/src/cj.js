...
lib.properties = {
	...
	manifest: [
		...
		{src:"img/r34bg.png", id:"r34bg"},
		{src:"img/r34bg2.png", id:"r34bg2"},
...
p.nominalBounds = new cjs.Rectangle(0,0,476,384);
...
(lib.r34bg = function() {
	this.initialize(img.r34bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1041,556);


(lib.r34bg2 = function() {
	this.initialize(img.r34bg2);
}).prototype = p = new cjs.Bitmap();
...
(lib.r18 = function(mode,startPosition,loop) {
	...
	// 图层 1
	this.instance = new lib.r18001();

	this.instance_1 = new lib.r18002();

	this.instance_2 = new lib.r18003();

	this.instance_3 = new lib.r18004();

	this.instance_4 = new lib.r18005();

	this.instance_5 = new lib.r18006();

	this.instance_6 = new lib.r18007();

	this.instance_7 = new lib.r18008();

	this.instance_8 = new lib.r18009();

	this.instance_9 = new lib.r18010();

	this.instance_10 = new lib.r18011();

	this.instance_11 = new lib.r18012();

	this.instance_12 = new lib.r18013();

	this.instance_13 = new lib.r18014();

	this.instance_14 = new lib.r18015();

	this.instance_15 = new lib.r18016();

	this.instance_16 = new lib.r18017();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_15}]},1).to({state:[{t:this.instance_16}]},1).wait(2));
...
(lib.zx3_xs8_1 = function(mode,startPosition,loop) {
	...
	this.text.setTransform(175.1,199.7);
...
p.nominalBounds = new cjs.Rectangle(8,-1,334.1,259.1);
...
(lib.zx3_xs7_1 = function(mode,startPosition,loop) {
	...
	this.text.lineWidth = 330;
	this.text.setTransform(171.1,185.7);
...
(lib.zx3_xs6_1 = function(mode,startPosition,loop) {
	...
	this.text.setTransform(171.6,186.2);
...
p.nominalBounds = new cjs.Rectangle(-21,-1,385.1,263.1);
...
(lib.zx3_xs5_1 = function(mode,startPosition,loop) {
	...
	this.text.lineHeight = 28;
	this.text.lineWidth = 330;
	this.text.setTransform(177.1,197.7);
...
p.nominalBounds = new cjs.Rectangle(10,-1,334.1,261.1);
...
(lib.zx3_xs4_1 = function(mode,startPosition,loop) {
	...
	this.text.lineHeight = 28;
	this.text.lineWidth = 330;
	this.text.setTransform(177.1,185.7);
...
p.nominalBounds = new cjs.Rectangle(10,-1,334.1,249.1);
...
(lib.zx3_xs3_1 = function(mode,startPosition,loop) {
	...
	this.text.lineHeight = 28;
	this.text.lineWidth = 330;
	this.text.setTransform(171.1,197.7);
...
p.nominalBounds = new cjs.Rectangle(4,-1,334.1,261.1);
...
p.nominalBounds = new cjs.Rectangle(4,-1,334.1,254.8);
...
(lib.zx2_xs6_1 = function(mode,startPosition,loop) {
	...
	this.text.lineHeight = 28;
	this.text.lineWidth = 330;
	this.text.setTransform(173.1,197.7);
...
p.nominalBounds = new cjs.Rectangle(6,-1,334.1,254.8);
...
(lib.zx2_xs3_1 = function(mode,startPosition,loop) {
	...
	this.text.lineHeight = 28;
	this.text.lineWidth = 330;
	this.text.setTransform(173.1,185.7);
...
(lib.zx2_xs1_1 = function(mode,startPosition,loop) {
	...
	this.text.setTransform(169.1,191.7);
...
p.nominalBounds = new cjs.Rectangle(0.1,-1,349.1,233.1);
...
(lib.zx1_xs8_1 = function(mode,startPosition,loop) {
	...
	this.text.lineHeight = 28;
	this.text.lineWidth = 334;
	this.text.setTransform(181.1,191.7);
...
(lib.zx1_xs7_1 = function(mode,startPosition,loop) {
	...
	this.text.lineHeight = 28;
	this.text.lineWidth = 334;
	this.text.setTransform(181.1,179.7);
...
p.nominalBounds = new cjs.Rectangle(2.1,-1,347.1,254.8);
...
(lib.zx1_xs3_1 = function(mode,startPosition,loop) {
	...
	this.text.setTransform(185.1,205.7);
...
(lib.zx1_xs2_1 = function(mode,startPosition,loop) {
	...
	this.text.lineHeight = 28;
	this.text.lineWidth = 334;
	this.text.setTransform(181.1,199.7);
...
(lib.zx1_xs1_1 = function(mode,startPosition,loop) {
	...
	this.text.setTransform(170.1,197.7);
...
(lib.zx1 = function(mode,startPosition,loop) {
	...
	this.instance_6.setTransform(2842.3,428.2,1,1,0,0,0,178.6,115.5);
...
(lib.r47 = function(mode,startPosition,loop) {
	...
	// 图层 3
	this.text = new cjs.Text("这位阿姨啊~她和我的球衣合影后去极光体验区了", "24px 'Heiti SC'", "#333333");
	this.text.textAlign = "center";
	this.text.lineHeight = 26;
	this.text.lineWidth = 304;
	this.text.setTransform(94,-76.3);
	this.text._off = true;
...
(lib.r32 = function(mode,startPosition,loop) {
	...
	// 图层 3
	this.text = new cjs.Text("人家拿小拳拳捶你胸口!!!(｡• ︿•̀｡)大坏蛋，打死你(つд⊂)", "24px 'Heiti SC'", "#333333");
	this.text.textAlign = "center";
	this.text.lineHeight = 26;
	this.text.lineWidth = 412;
	this.text.setTransform(90.1,-73.3);
	this.text._off = true;
...
(lib.all = function(mode,startPosition,loop) {
	...
	this.r35.setTransform(3922.5,1105,1,1,0,0,0,35.5,64);
	...
	// 34背景
	this.instance_1 = new lib.r34bg2();
	this.instance_1.setTransform(3631,928);
	...
	// 34背景
	this.instance_2 = new lib.r34bg();
	this.instance_2.setTransform(3141,753);
	...
	this.r37.setTransform(4094.5,944.5,1,1,0,0,0,64.5,58.5);

	this.timeline.addTween(cjs.Tween.get(this.r37).wait(1));

	// 33覆盖
	this.instance_3 = new lib.r31002();
	this.instance_3.setTransform(3936,704);
	...
	this.r25.setTransform(2990.5,960.5,1,1,0,0,0,233.5,227.5);
	...
	this.r08.setTransform(1596.5,392,1,1,0,0,0,36.5,78);

	this.timeline.addTween(cjs.Tween.get(this.r08).wait(1));

	// 9号
	this.r09 = new lib.r09();
	this.r09.setTransform(1558,399,1,1,0,0,0,238,192);
	...
	this.instance_4.setTransform(3034.5,667,1,1,0,0,0,3034.5,667);
